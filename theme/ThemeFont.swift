...
public struct ThemeFont:Decodable,ThemeFontKind{
   ...
   public init(from decoder: Decoder) throws {
      ...
      system = try container.decode(key: .system, transformer: UIFontTransformer.init())
      systemBold = try container.decode(key: .systemBold, transformer: UIFontTransformer.init())
   }
}
